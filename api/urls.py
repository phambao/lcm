...
from api.views.company_setting import ChangeOrderSettingGenericView, ChangeOrderSettingGenericViewDetailGenericView
...
urlpatterns = [
    ...
    path('company/setting/change-order', ChangeOrderSettingGenericView.as_view()),
    path('company/setting/change-order/<int:pk>/', ChangeOrderSettingGenericViewDetailGenericView.as_view()),
